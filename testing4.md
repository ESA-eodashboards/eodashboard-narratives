...
## Introduction
####  Background
Here, we will add a brief introduction on the ideathon project and its intention.

#### Team introduction  
Here you will need to give a brief background information on the your project, team.  
...
#### Text 
You can simply discuss your issue using simple text and discriptions. 

#### Image
If it is needed you can add some reference images anywhere you want!  
For Example, below is the example of image in your text. 
