...
The **grayscale image shows EarthCARE's MSI visible channel (0.67 µm)** Level-1B acquisition from June 16, 2025, displaying top-of-atmosphere reflectance. Brighter areas indicate higher reflectance, typically corresponding to thick clouds or bright surfaces, while darker areas represent ocean or cloud-free regions. The **red line** marks the **satellite's ground track for that orbit**, illustrating the narrow swath EarthCARE covers in a single pass.
