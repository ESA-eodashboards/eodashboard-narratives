...
# Changes at shipping terminals in Japan <!--{ as="img" mode="hero" src="https://safety4sea.com/wp-content/uploads/2023/07/shutterstock_669659890.jpg?itok=swuFgYuA&w=640&q=75?w=1920&ssl=1" }-->
### Observed car containers in the port of Nagoya <!--{ style="font-size:1.5rem;opacity:0.7;margin-top:1rem;" }-->
### image source: Shutterstock <!--{ style="font-size:1rem;opacity:0.7;margin-top:1rem;" }-->
##
...
### image source: https://www.porttechnology.org/ <!--{ style="font-size:1rem;opacity:0.7;margin-top:1rem;" }-->
## 
