...
- **6- K-means clustering:** K-means clustering was applied in the PCA-reduced feature space, testing different solutions from **k = 4–15**. Inertia, Silhouette Score and the Calinski–Harabasz Index were used to evaluate the different solutions, and six clusters were finally adopted for subsequent analysis.
