...
# [STORY_TITLE] <!--{ as="img" mode="hero" src="[COVER_IMAGE_URL]" }-->
...
## Results
#### Initial findings: [STUDY_AREA_1] - [YEAR] Classification Results
...
[Include quantitative results table if available.]

[Explain differences across methods, data sources, or polarizations.]

## Next Steps
[Describe project timeline, phases, research activities, and future directions.]

Project Timeline and Activities

Activity | Period | Deliverables
--- | --- | ---
[Activity 1] | [Period] | [Deliverable]
[Activity 2] | [Period] | [Deliverable]
...
