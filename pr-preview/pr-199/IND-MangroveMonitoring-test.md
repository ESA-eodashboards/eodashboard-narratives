...
This closer view highlights the ALOS-2 PALSAR-2 ScanSAR Level 2.2 yearly median composite (2024) over Kuala Selat, rendered here in its HV (cross-polarized) channel over the terrain basemap. HV backscatter is generated by multiple scattering within a 3D target, the classic signature of dense vegetation canopy, making it the more sensitive of the two polarizations for distinguishing mangrove stands from open water, bare soil, and aquaculture ponds. Brighter tones indicate stronger volume scattering, consistent with denser or more structurally complex mangrove cover, while darker tones over open water and cleared/converted areas reflect the smoother, weaker cross-polarized return typical of those surfaces.
