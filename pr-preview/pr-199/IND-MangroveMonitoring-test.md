...
HV backscatter is generated by multiple scattering within a 3D target, the classic signature of dense vegetation canopy, making it the more sensitive of the two polarizations for distinguishing mangrove stands from open water, bare soil, and aquaculture ponds. Brighter tones indicate stronger volume scattering, consistent with denser or more structurally complex mangrove cover, while darker tones over open water and cleared/converted areas reflect the smoother, weaker cross-polarized return typical of those surfaces. This 2021 composite serves as the baseline against which later change is measured.
...
This is the same HV backscatter view over Kuala Selat three years later, drawn from the ALOS-2 PALSAR-2 ScanSAR Level 2.2 yearly median composite for 2024. Comparing this composite against the 2021 baseline shown in the previous step makes any change in vegetation structure: mangrove loss, degradation, or recovery, directly visible as a shift in HV brightness over the same coastline, independent of cloud cover or time of day.
