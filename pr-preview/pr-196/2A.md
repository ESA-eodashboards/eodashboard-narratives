...
1. **Data extraction, selection and preprocessing:** the required data from the selected datasets were selected for the study area. 
2. **Temporal compositing and spatial aggregation:** multiple observations acquired between **June to August 2021** were combined.
3. **Grid alignment and feature merging:** datasets were aligned to a common spatial grid.
4. **Normalization & PCA**
