...
## Map Example <!--{as="eox-map" style="width: 100%; height: 500px;" layers='[ { "type": "Tile", "properties": { "id": "TOPO-WMS" }, "source": { "type": "TileWMS", "url": "https://sh.dataspace.copernicus.eu/ogc/wms/a87db291-f9b2-4980-b025-c0cfcbda9820", "params": { "LAYERS": "COLOR_INFRARED" } } } ]' zoom="12" center=[16.35,48.2] }-->
